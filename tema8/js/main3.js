var questions = [
    ...
    function pasapalabra(){
        ...
        evaluar.onclick = function(){
            ...
            if(questions[x].answer === resp.value){
                    ...
                    abcNuevaVuelta.push(abecedario[x]);
                    resp.value = "";
                    x++;
                    document.getElementById('pregunta').innerHTML = questions[x].question;
        ...
        segVuelta.onclick = function(){
                x = 0;
                document.getElementById('pregunta').innerHTML = nuevaVuelta[x].question;
                if(nuevaVuelta[x].answer === resp.value){
                    //nuevaVuelta[x].status=1;
                    abcNuevaVuelta[x].style.backgroundColor = '#19A547';
                    resp.value = "";
                    respCorrectas++;
                    document.getElementById('aciertos').innerHTML = respCorrectas;
                    x++;
                    ...
                    //nuevaVuelta[x].status=1;
                    abcNuevaVuelta[x].style.backgroundColor = '#AF1B1B';
                    resp.value = "";
                    respIncorrectas++;
                    document.getElementById('fallos').innerHTML = respIncorrectas;
                    x++;
